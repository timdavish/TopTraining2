...
describe('Pipe: Ellipsis', () => {
	...
	necessitatibus quos ea autem accusantium dolorvoluptates
	voluptatibus. Doloribus libero, facilis ea nam quibusdam aut
	labore itaque aliquid, optio. Rerum, dolorum! Error ratione
	tempore nesciunt magnam reprehenderit earum tempora aliquam
	laborum consectetur repellendus, nam hic maiores, qui corrupti
	saepe possimus, velit impedit eveniet totam. Aliquid qui corrupti
	facere. Alias itaque pariatur aliquam, nemo praesentium. Iure
	delectus, nemo natus! Libero ducimus aspernatur laborum voluptatibus
	officiis eaque enim minus accusamus, harum facilis sed eum! Sit vero
	vitae voluptatibus deleniti, corporis deserunt? Optio reprehenderit
